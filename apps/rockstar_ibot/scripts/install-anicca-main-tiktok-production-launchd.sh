...
TEMPLATE="$APP_DIR/launchd/ai.anicca.rockstar_ibot-anicca-main-tiktok.plist.template"
TARGET="${HOME}/Library/LaunchAgents/ai.anicca.rockstar_ibot-anicca-main-tiktok.plist"
DOMAIN="gui/$(id -u)"
LABEL="ai.anicca.rockstar_ibot-anicca-main-tiktok"
TEMP="$(mktemp "${TMPDIR:-/tmp}/rockstar_ibot-anicca-main-tiktok.plist.XXXXXX")"
trap 'rm -f "$TEMP"' EXIT
